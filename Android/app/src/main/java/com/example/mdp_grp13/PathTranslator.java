...
//                gridMap.setCurCoord(curX, curY, dir);
    ...
    public void translatePath(String stmCommand) {
        ...
        int commandValue = 10; //commandValue represents the value to move forwards or backwards.

        //Case 1: is a MOVE command. Expects a syntax of eg. MOVE,<DIRECTION>,<DISTANCE IN BLOCKS>.
        if(stmCommand.contains("MOVE")){

            //set commandValue to <DISTANCE IN BLOCKS>
            commandValue = 10 * Integer.parseInt(stmCommand.split(",")[2].replace("\n",""));

            //set commandType for <DIRECTION>
            String direction = stmCommand.split(",")[1].replace("\n","");
