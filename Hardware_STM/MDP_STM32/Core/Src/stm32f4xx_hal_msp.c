...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOE, SERVO_PWM_Pin|GPIO_PIN_14);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(MOTOR_A_CH1_GPIO_Port, MOTOR_A_CH1_Pin);

    HAL_GPIO_DeInit(MOTOR_A_CH2_GPIO_Port, MOTOR_A_CH2_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, MOTOR_B_CH1_Pin|MOTOR_B_CH2_Pin);
